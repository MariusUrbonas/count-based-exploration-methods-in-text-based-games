...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Look at you, bigshot, walking into a cubicle like it isn't some huge deal. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "Well, here we are in the laundry place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest0 with "go east / go north / go west / go west / go west / go west / go north / go west / go north / take coin"
...
Rule for printing the banner text:
	say "Welcome to another fast paced round of TextWorld! pick up the coin in the steam room.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another fast paced round of TextWorld! pick up the coin in the steam room.".
