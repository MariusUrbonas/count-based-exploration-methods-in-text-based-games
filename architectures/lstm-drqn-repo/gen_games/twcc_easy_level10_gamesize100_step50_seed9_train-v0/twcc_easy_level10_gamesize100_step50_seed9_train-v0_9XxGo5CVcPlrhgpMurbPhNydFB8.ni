...
The shower part 0 is some text that varies. The shower part 0 is "Guess what, you are in the place we're calling the shower. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The office part 0 is some text that varies. The office part 0 is "Ah, the office. This is some kind of office, really great normal vibes in this place, a wonderful normal atmosphere. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0 with "go west / go west / go north / go north / go west / go south / go west / go south / go south / take coin"
...
Rule for printing the banner text:
	say "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! recover the coin from the garage.[line break]".
...
An objective is some text that varies. The objective is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! recover the coin from the garage.".
