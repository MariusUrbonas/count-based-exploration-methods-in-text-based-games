...
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_2 and the r_8 and the r_9 are rooms.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. A typical one. You start to take note of what's in the room.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "A laminated sign tells you that you are now in the cookhouse.
...
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_2 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_2 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go east / go south / go south / go west / go south / go east / go east / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Your objective is to pick up the coin from the cookhouse.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to pick up the coin from the cookhouse.".
