...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in an ordinary kind of place. That is to say, you're in a laundry place.
...
The basement part 0 is some text that varies. The basement part 0 is "A rusty placard tells you that you are now in the basement.
...
Test quest0 with "go north / go east / go east / go east / go east / go south / go south / go south / go south / take coin"
...
Rule for printing the banner text:
	say "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! pick-up the coin from the floor of the basement.[line break]".
...
An objective is some text that varies. The objective is "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! pick-up the coin from the floor of the basement.".
