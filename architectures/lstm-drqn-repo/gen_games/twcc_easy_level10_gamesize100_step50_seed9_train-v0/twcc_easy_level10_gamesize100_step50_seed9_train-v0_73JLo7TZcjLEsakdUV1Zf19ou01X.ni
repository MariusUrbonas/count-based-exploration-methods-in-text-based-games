...
The r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_2 and the r_3 are rooms.
...
The attic part 0 is some text that varies. The attic part 0 is "You are in an attic. An ordinary one. Let's see what's in here.
...
The salon part 0 is some text that varies. The salon part 0 is "Ah, the salon. This is some kind of salon, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it.
...
The steam room part 0 is some text that varies. The steam room part 0 is "I am required to announce that you are now in the steam room.
...
The r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_2 and the r_3 are rooms.
The r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_2 and the r_3 are privately-named.
...
Test quest0 with "go south / go south / go south / go south / go west / go south / go west / go south / go east / take coin"
...
Rule for printing the banner text:
	say "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Your task for today is to pick-up the coin from the floor of the salon.[line break]".
...
An objective is some text that varies. The objective is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Your task for today is to pick-up the coin from the floor of the salon.".
