...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_6 are rooms.

The internal name of r_1 is "vault".
The printed name of r_1 is "-= Vault =-".
The vault part 0 is some text that varies. The vault part 0 is "You arrive in a vault. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You are in a cookhouse. An ordinary one. You can barely contain your excitement.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You've just shown up in a workshop. I guess you better just go and list everything you see here.
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_6 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_6 are privately-named.
...
Test quest0 with "go east / go south / go west / go north / go west / go north / go north / go west / go west / take coin"
...
Rule for printing the banner text:
	say "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! Your task for today is to recover the coin that's in the office.[line break]".
...
An objective is some text that varies. The objective is "I hope your ready to go into rooms and interact with objects, because you've just entered TextWorld! Your task for today is to recover the coin that's in the office.".
