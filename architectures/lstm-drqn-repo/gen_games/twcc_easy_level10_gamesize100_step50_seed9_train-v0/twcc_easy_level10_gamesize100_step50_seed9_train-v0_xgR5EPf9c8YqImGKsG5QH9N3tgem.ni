...
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_2 and the r_9 are rooms.

The internal name of r_0 is "workshop".
The printed name of r_0 is "-= Workshop =-".
The workshop part 0 is some text that varies. The workshop part 0 is "I am required to announce that you are now in the workshop. Let's see what's in here.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. An usual one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. A typical kind of place. You start to take note of what's in the room.
...
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_2 and the r_9 are rooms.
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_2 and the r_9 are privately-named.
...
Test quest0 with "go west / go south / go south / go east / go east / go east / go south / go east / go north / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please lift the coin from the floor of the attic.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please lift the coin from the floor of the attic.".
