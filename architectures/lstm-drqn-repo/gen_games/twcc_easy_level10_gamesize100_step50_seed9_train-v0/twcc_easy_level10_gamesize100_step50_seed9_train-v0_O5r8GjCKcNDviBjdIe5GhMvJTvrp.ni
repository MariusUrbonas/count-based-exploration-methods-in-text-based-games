...
The r_1 and the r_0 and the r_2 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_3 are rooms.
...
The shower part 0 is some text that varies. The shower part 0 is "You find yourself in a shower. An usual kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. An usual one. You begin to take stock of what's in the room.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a chamber. A typical kind of place. You begin to take stock of what's in the room.
...
The bar part 0 is some text that varies. The bar part 0 is "You've entered a bar. You begin to take stock of what's here.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Well, here we are in a recreation zone. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_1 and the r_0 and the r_2 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_3 are rooms.
The r_1 and the r_0 and the r_2 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_3 are privately-named.
...
Test quest0 with "go east / go east / go south / go south / go east / go south / go west / go north / go east / take coin"
...
Rule for printing the banner text:
	say "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! retrieve the coin from the floor of the playroom.[line break]".
...
An objective is some text that varies. The objective is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! retrieve the coin from the floor of the playroom.".
