...
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_0 and the r_4 and the r_7 and the r_8 and the r_9 are rooms.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in an ordinary kind of place. That is to say, you're in a dish-pit.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a typical kind of place. That is to say, you're in a bedroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. A normal one. You start to take note of what's in the room.
...
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_0 and the r_4 and the r_7 and the r_8 and the r_9 are rooms.
The r_2 and the r_1 and the r_3 and the r_6 and the r_5 and the r_0 and the r_4 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0 with "go south / go east / go east / go north / go north / go east / go south / go south / go south / take coin"
...
Rule for printing the banner text:
	say "Your objective is to retrieve the coin that's in the studio.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to retrieve the coin that's in the studio.".
