...
The r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_5 are rooms.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You're now in a kitchenette. Okay, just remember what you're here to do, and everything will go great.
...
The study part 0 is some text that varies. The study part 0 is "This might come as a shock to you, but you've just come into a study. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical one. You can barely contain your excitement.
...
The r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_5 are rooms.
The r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_5 are privately-named.
...
Test quest0 with "go north / go east / go south / go west / go north / go north / go east / go north / go east / take coin"
...
Rule for printing the banner text:
	say "Welcome to another fast paced round of TextWorld! Your task for today is to retrieve the coin that's in the office.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another fast paced round of TextWorld! Your task for today is to retrieve the coin that's in the office.".
