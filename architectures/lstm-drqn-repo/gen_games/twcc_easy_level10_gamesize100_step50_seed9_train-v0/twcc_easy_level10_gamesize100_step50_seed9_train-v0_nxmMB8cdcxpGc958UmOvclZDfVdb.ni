...
The scullery part 0 is some text that varies. The scullery part 0 is "I just think it's great that you've just entered a scullery. You begin to take stock of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "Well how about that, you are in a place we're calling a study. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The chamber part 0 is some text that varies. The chamber part 0 is "You have entered the most usual of all possible chambers.
...
The restroom part 0 is some text that varies. The restroom part 0 is "Well how about that, you are in a place we're calling a restroom. You start to take note of what's in the room.
...
The shower part 0 is some text that varies. The shower part 0 is "You have stumbled into the most typical of all possible showers. You can barely contain your excitement.
...
Test quest0 with "go west / go north / go east / go south / go east / go north / go north / go north / go north / take coin"
...
Rule for printing the banner text:
	say "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! pick up the coin in the bar.[line break]".
...
An objective is some text that varies. The objective is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! pick up the coin in the bar.".
