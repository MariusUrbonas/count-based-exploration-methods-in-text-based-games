...
The r_1 and the r_2 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_3 and the r_4 and the r_9 are rooms.
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. A normal one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "I am stoked to announce that you are now in the cookhouse. Okay, just remember what you're here to do, and everything will go great.
...
The r_1 and the r_2 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_3 and the r_4 and the r_9 are rooms.
The r_1 and the r_2 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_3 and the r_4 and the r_9 are privately-named.
...
Test quest0 with "go north / go west / go north / go north / go north / go west / go north / go west / go north / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please pick up the coin from the bedroom.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please pick up the coin from the bedroom.".
