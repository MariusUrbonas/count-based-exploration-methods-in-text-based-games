...
The r_1 and the r_0 and the r_3 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_9 are rooms.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. A typical kind of place. You start to take note of what's in the room.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just sauntered into a laundromat. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_1 and the r_0 and the r_3 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_9 are rooms.
The r_1 and the r_0 and the r_3 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_9 are privately-named.
...
Test quest0 with "go east / go south / go east / go south / go east / go east / go south / go east / go north / take coin"
...
Rule for printing the banner text:
	say "Welcome to another life changing round of TextWorld! pick up the coin that's in the launderette.[line break]".
...
An objective is some text that varies. The objective is "Welcome to another life changing round of TextWorld! pick up the coin that's in the launderette.".
