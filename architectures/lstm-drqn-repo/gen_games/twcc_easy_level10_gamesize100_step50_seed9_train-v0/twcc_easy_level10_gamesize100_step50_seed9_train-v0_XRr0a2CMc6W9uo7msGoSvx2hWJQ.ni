...
The r_1 and the r_0 and the r_2 and the r_3 and the r_6 and the r_7 and the r_9 and the r_8 and the r_4 and the r_5 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "I am pleased to announce that you are now in the basement. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "A well framed sign tells you that you are now in the kitchen. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. A typical kind of place. Let's see what's in here.
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_6 and the r_7 and the r_9 and the r_8 and the r_4 and the r_5 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_6 and the r_7 and the r_9 and the r_8 and the r_4 and the r_5 are privately-named.
...
Test quest0 with "go east / go south / go west / go north / go north / go north / go west / go north / go east / take coin"
...
Rule for printing the banner text:
	say "Your objective is to retrieve the coin that's in the cellar.[line break]".
...
An objective is some text that varies. The objective is "Your objective is to retrieve the coin that's in the cellar.".
