...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_3 and the r_9 are rooms.

The internal name of r_0 is "steam room".
The printed name of r_0 is "-= Steam Room =-".
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. A standard kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal one. Let's see what's in here.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You are in a recreation zone. A typical kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_3 and the r_9 are rooms.
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_6 and the r_8 and the r_7 and the r_3 and the r_9 are privately-named.
...
Test quest0 with "go west / go west / go south / go south / go east / go east / go north / go east / go north / take coin"
...
Rule for printing the banner text:
	say "You are now playing a exciting round of TextWorld! pick up the coin that's in the pantry.[line break]".
...
An objective is some text that varies. The objective is "You are now playing a exciting round of TextWorld! pick up the coin that's in the pantry.".
