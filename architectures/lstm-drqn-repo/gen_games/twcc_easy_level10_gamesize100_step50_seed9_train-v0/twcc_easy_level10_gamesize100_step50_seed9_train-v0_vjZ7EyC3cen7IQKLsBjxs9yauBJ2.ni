...
The scullery part 0 is some text that varies. The scullery part 0 is "A rusty board tells you that you are now in the scullery. Let's see what's in here.
...
Test quest0 with "go south / go east / go north / go east / go east / go south / go south / go west / go west / take coin"
...
Rule for printing the banner text:
	say "You are now playing a profound game of TextWorld! Your task for today is to pick up the coin in the study.[line break]".
...
An objective is some text that varies. The objective is "You are now playing a profound game of TextWorld! Your task for today is to pick up the coin in the study.".
