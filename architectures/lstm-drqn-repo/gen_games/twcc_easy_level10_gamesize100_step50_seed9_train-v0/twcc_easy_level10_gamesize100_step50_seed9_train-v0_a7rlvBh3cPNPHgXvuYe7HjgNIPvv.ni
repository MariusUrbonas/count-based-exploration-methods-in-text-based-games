...
The r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_1 and the r_9 are rooms.
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. An usual one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_1 and the r_9 are rooms.
The r_2 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_1 and the r_9 are privately-named.
...
Test quest0 with "go south / go south / go west / go north / go west / go south / go east / go east / go south / take coin"
...
Rule for printing the banner text:
	say "Hey, thanks for coming over to TextWorld! Please take the coin from the cookhouse.[line break]".
...
An objective is some text that varies. The objective is "Hey, thanks for coming over to TextWorld! Please take the coin from the cookhouse.".
