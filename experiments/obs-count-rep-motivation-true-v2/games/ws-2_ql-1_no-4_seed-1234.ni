...
The attic part 0 is some text that varies. The attic part 0 is "You've just shown up in an attic.
 ...
 Look over there! a shelf. The shelf is usual.[if there is something on the s_0] On the shelf you can make out [a list of things on the s_0].[end if]".
...
The attic part 2 is some text that varies. The attic part 2 is " You can see a stand. [if there is something on the s_1]You see [a list of things on the s_1] on the stand.[end if]".
...
The description of o_1 is "The pair of pants is well-used.".
...
Test quest0_0 with "put shirt on shelf"
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to place the shirt on the shelf.".
