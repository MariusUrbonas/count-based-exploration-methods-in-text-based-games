...
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if c_1 is open and the c_1 contains nothing] The cabinet is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The playroom part 0 is some text that varies. The playroom part 0 is "You are in a playroom.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a suitcase![if c_0 is open and there is something in the c_0] The suitcase contains [a list of things in the c_0]![end if]".
...
Test quest0_0 with "take sandwich from suitcase / go east / drop sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First thing I need you to do is to recover the sandwich from the suitcase inside the playroom. If".
The objective part 1 is some text that varies. The objective part 1 is " you can get your hands on the sandwich, go to the east. With that accomplished, deposit the sandwich on the floor of the kitchenette. Once that's all handled, you can stop!".
