...
Test quest0_0 with "take keycard from bar / go south / drop keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, take the keycard from the bar. With the keycard, attempt to ".
The objective part 1 is some text that varies. The objective part 1 is "move south. After that, place the keycard on the floor of the cellar. That's it!".
