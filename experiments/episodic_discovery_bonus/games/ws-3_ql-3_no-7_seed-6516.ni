...
Test quest0_0 with "go south / go east / take keycard from non-euclidean box"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First, it would be great if you could attempt to head south. Then, make an effort to venture east. And then, take the keycard from the non-euclidean ".
The objective part 1 is some text that varies. The objective part 1 is "box in the studio. Got that? Good!".
