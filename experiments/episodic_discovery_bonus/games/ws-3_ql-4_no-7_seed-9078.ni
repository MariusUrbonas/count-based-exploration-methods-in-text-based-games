...
Test quest0_0 with "take Henderson's style passkey / unlock Henderson's style safe with Henderson's style passkey / open Henderson's style safe / take nest of shrimp from Henderson's style safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First of all, pick-up the Henderson's style passkey from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "kitchenette. Having picked up the Henderson's style passkey, unlock the Henderson's style safe in the kitchenette with the Henderson's style passkey. And then, open the Henderson's style safe in the k".
The objective part 2 is some text that varies. The objective part 2 is "itchenette. And then, pick up the nest of shrimp from the Henderson's style safe in the kitchenette. Alright, thanks!".
