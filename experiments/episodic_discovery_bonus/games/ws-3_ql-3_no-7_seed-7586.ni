...
The recreation zone part 1 is some text that varies. The recreation zone part 1 is " portmanteau, which looks normal, in the corner.[if c_0 is open and there is something in the c_0] The portmanteau contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The recreation zone part 2 is some text that varies. The recreation zone part 2 is "[if c_0 is open and the c_0 contains nothing] The portmanteau is empty, what a horrible day![end if]".
...
The description of c_0 is "The portmanteau looks strong, and impossible to open. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of f_2 is "The peanut looks appetizing.".
...
The description of o_1 is "The ladle appears well matched to everything else here".
...
Test quest0_0 with "go south / take loaf of bread from portmanteau / eat loaf of bread"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First thing I need you to do is to make an attempt to venture south. With that accomplished, retrieve the loaf o".
The objective part 1 is some text that varies. The objective part 1 is "f bread from the portmanteau. And then, eat the loaf of bread. Alright, thanks!".
