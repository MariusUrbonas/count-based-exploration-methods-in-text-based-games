...
Test quest0_0 with "go east / take keycard from non-euclidean box"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting game of TextWorld! First of all, make an attempt to head east. With that done, retrieve the keycard from the non-euclidean box. That's it!".
