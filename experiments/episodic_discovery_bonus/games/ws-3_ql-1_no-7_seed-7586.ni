...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You arrive in a recreation zone. A standard one.
 ...
 You smell an awful smell, and follow it to a bookshelf. [if there is something on the s_0]On the bookshelf you make out [a list of things on the s_0].[end if]".
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. What's the point of an empty bookshelf?[end if]".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You arrive in a dish-pit. A normal kind of place. You start to take note of what's in the room.
...
The description of f_2 is "The gummy bear looks delectable.".
...
The f_2 is in r_0.
The f_2 is edible.
The description of o_2 is "The controller is clean.".
...
The description of o_0 is "The worm seems well matched to everything else here".
The printed name of o_0 is "worm".
Understand "worm" as o_0.
The player carries the o_0.
The description of o_1 is "The golf tee seems to fit in here".
...
Test quest0_0 with "eat licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to eat the licorice strip.".
