...
The attic part 0 is some text that varies. The attic part 0 is "You've just shown up in an attic.
 ...
 Look over there! a stand. The stand is usual.[if there is something on the s_0] On the stand you can make out [a list of things on the s_0].[end if]".
...
The attic part 2 is some text that varies. The attic part 2 is " You can see a rack. [if there is something on the s_1]You see [a list of things on the s_1] on the rack.[end if]".
The attic part 3 is some text that varies. The attic part 3 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. Hopefully this doesn't make you too upset.[end if]".
...
The s_1 is in r_1.
The description of o_1 is "The lampshade looks well matched to everything else here".
...
Test quest0_0 with "go east / take shirt / put shirt on stand"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. Your first objective is to make an attempt to travel east. And then, retrieve the s".
The objective part 1 is some text that varies. The objective part 1 is "hirt in the attic. Then, sit the shirt on the stand in the attic. And if you do that, you're the winner!".
