...
The attic part 0 is some text that varies. The attic part 0 is "You've entered an attic.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toolbox.[if c_0 is open and there is something in the c_0] The toolbox contains [a list of things in the c_0].[end if]".
The attic part 1 is some text that varies. The attic part 1 is "[if c_0 is open and the c_0 contains nothing] The toolbox is empty! This is the worst thing that could possibly happen, ever![end if]".
...
Test quest0_0 with "take keycard from toolbox"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please pick up the keycard from the toolbox in the attic.".
