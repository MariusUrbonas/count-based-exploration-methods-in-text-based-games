...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. An usual one.
 ...
 What's that over there? It looks like it's a non-euclidean box. Classic TextWorld.[if c_0 is open and there is something in the c_0] The non-euclidean box contains [a list of things in the c_0].[end if]".
...
The studio part 2 is some text that varies. The studio part 2 is " You can see [if c_1 is locked]a locked[else if c_1 is open]an open[otherwise]a closed[end if]".
The studio part 3 is some text that varies. The studio part 3 is " case, which looks normal, in the room.[if c_1 is open and there is something in the c_1] The case contains [a list of things in the c_1]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The studio part 4 is some text that varies. The studio part 4 is "[if c_1 is open and the c_1 contains nothing] The case is empty! What a waste of a day![end if]".
...
The basement part 0 is some text that varies. The basement part 0 is "You find yourself in a basement. An usual one. I guess you better just go and list everything you see here.
...
The chamber part 0 is some text that varies. The chamber part 0 is "Well, here we are in the chamber.
 ...
 You can see a bar. The bar is normal.[if there is something on the s_0] On the bar you see [a list of things on the s_0].[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the bar! oh well.[end if]".
...
The c_0 is in r_1.
The c_0 is closed.
The description of c_1 is "The case looks strong, and impossible to bash open. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_1 is "case".
Understand "case" as c_1.
The c_1 is in r_1.
The c_1 is open.
The description of k_1 is "The non-euclidean passkey looks useful".
...
The description of o_0 is "The scarf would seem to be well matched to everything else here".
...
Test quest0_0 with "go south / go east / open non-euclidean box / take keycard from non-euclidean box"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to attempt to venture south. Next, move east. Next, ".
The objective part 1 is some text that varies. The objective part 1 is "open the non-euclidean box in the studio. And then, recover the keycard from the non-euclidean box. Once that's all handled, you can stop!".
