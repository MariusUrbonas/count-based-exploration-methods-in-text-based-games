...
The kitchenette part 2 is some text that varies. The kitchenette part 2 is " You make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The kitchenette part 3 is some text that varies. The kitchenette part 3 is " refrigerator.[if c_1 is open and there is something in the c_1] The refrigerator contains [a list of things in the c_1].[end if]".
...
The playroom part 0 is some text that varies. The playroom part 0 is "Well how about that, you are in a place we're calling a playroom. Okay, just remember what you're here to do, and everything will go great.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. A typical one. The room is well lit.
 ...
 You see a shelf. You wonder idly who left that here. The shelf is standard.[if there is something on the s_0] On the shelf you can make out [a list of things on the s_0].[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. Aw, here you were, all excited for there to be things on it![end if]".
...
The c_0 is in r_1.
The c_0 is closed.
The description of c_1 is "The refrigerator looks strong, and impossible to break open. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of o_1 is "The frisbee is clean.".
...
Test quest0_0 with "go south / open safe / take insect from safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to attempt to travel south. Okay, and then, ensure that the safe within the kitc".
The objective part 1 is some text that varies. The objective part 1 is "henette is open. After that, recover the insect from the safe. And if you do that, you're the winner!".
