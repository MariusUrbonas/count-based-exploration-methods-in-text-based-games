...
The attic part 2 is some text that varies. The attic part 2 is " You can see a rack. [if there is something on the s_0]You see [a list of things on the s_0] on the rack. Huh, weird.[end if]".
...
The o_2 and the o_0 and the o_3 and the o_1 are object-likes.
The o_2 and the o_0 and the o_3 and the o_1 are privately-named.
The r_1 and the r_0 and the r_2 are rooms.
...
The description of o_3 is "The worm is brand new.".
The printed name of o_3 is "worm".
Understand "worm" as o_3.
The player carries the o_3.
The description of o_1 is "The cane is clean.".
...
Test quest0_0 with "go south / go east / open American style chest / take broom from American style chest / put broom on rack"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to take a trip south. Okay, and then, move east. Okay, and then, ensure th".
The objective part 1 is some text that varies. The objective part 1 is "at the American style chest inside the attic is open. And then, pick up the broom from the American style chest in the attic. If you can get your hands on the broom, place the broom on the rack in the".
The objective part 2 is some text that varies. The objective part 2 is " attic. Alright, thanks!".
