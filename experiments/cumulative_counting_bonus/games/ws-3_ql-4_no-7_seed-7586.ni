...
Test quest0_0 with "go south / open formless safe / take licorice strip from formless safe / eat licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, travel south. After that, make sure that the formless safe is wide open. And then, retrieve the licorice strip from the formless safe i".
The objective part 1 is some text that varies. The objective part 1 is "nside the recreation zone. And then, eat the licorice strip. And once you've done that, you win!".
