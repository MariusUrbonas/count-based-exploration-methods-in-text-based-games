...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You're now in the kitchenette.
 ...
 You see a Henderson's style safe.[if c_0 is open and there is something in the c_0] The Henderson's style safe contains [a list of things in the c_0].[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The Henderson's style safe is empty![end if]".
The kitchenette part 2 is some text that varies. The kitchenette part 2 is " You make out a bowl. [if there is something on the s_0]You see [a list of things on the s_0] on the bowl.[end if]".
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. A typical one. The room is well lit.

 You see a shelf. You wonder idly who left that here. The shelf is standard.[if there is something on the s_1] On the shelf you can make out [a list of things on the s_1].[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if there is nothing on the s_1] But the thing is empty, unfortunately. Aw, here you were, all excited for there to be things on it![end if]".
The launderette part 2 is some text that varies. The launderette part 2 is " You can see a rack. [if there is something on the s_2]On the rack you make out [a list of things on the s_2].[end if]".
The launderette part 3 is some text that varies. The launderette part 3 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of junk.[end if]".
...
The c_0 is in r_1.
The c_0 is closed.
The description of f_0 is "The cookie looks tantalizing.".
The printed name of f_0 is "cookie".
Understand "cookie" as f_0.
The f_0 is in r_2.
The f_0 is edible.
The description of k_2 is "The metal of the Henderson's style passkey is antiqued.".
The printed name of k_2 is "Henderson's style passkey".
Understand "Henderson's style passkey" as k_2.
...
Test quest0_0 with "go south / take keycard from bowl"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First step, head south. With that done, take the keycard from the bowl in the kitch".
The objective part 1 is some text that varies. The objective part 1 is "enette. Got that? Good!".
