...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You find yourself in a recreation zone. A typical kind of place.
 ...
 Hey, want to see a formless safe? Look over there, a formless safe. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_0 is open and there is something in the c_0] The formless safe contains [a list of things in the c_0].[end if]".
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if c_0 is open and the c_0 contains nothing] The formless safe is empty! What a waste of a day![end if]".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You arrive in a dish-pit. An ordinary kind of place.
 ...
 You can see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0]. Hmmm... what else, what else?[end if]".
The dish-pit part 1 is some text that varies. The dish-pit part 1 is "[if there is nothing on the s_0]But the thing is empty, unfortunately. It would have been so cool if there was stuff on the table.[end if]".
...
The description of c_0 is "The formless safe looks strong, and impossible to break open. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_0 is in r_1.
The c_0 is locked.
The description of f_2 is "that's a standard pizza!".
...
The description of k_0 is "The formless latchkey looks useful".
...
Test quest0_0 with "go south / unlock formless safe with formless latchkey / open formless safe / take licorice strip from formless safe / eat licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! First stop, head south. If you can get around to doing that, make sure that t".
The objective part 1 is some text that varies. The objective part 1 is "he formless safe is unlocked. Then, open the formless safe. Having pulled open the formless safe, recover the licorice strip from the formless safe. If you have taken the licorice strip, eat the licor".
The objective part 2 is some text that varies. The objective part 2 is "ice strip. Once that's all handled, you can stop!".
