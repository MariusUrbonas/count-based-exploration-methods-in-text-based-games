...
Test quest0_0 with "take keycard from non-euclidean box"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your task for today is to pick up the keycard from the non-euclidean box.".
