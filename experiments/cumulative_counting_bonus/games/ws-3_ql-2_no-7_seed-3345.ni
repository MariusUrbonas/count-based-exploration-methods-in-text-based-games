...
Test quest0_0 with "take frisbee from stand / insert frisbee into chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! Your first objective is to take the frisbee from the stand inside the cellar. And then, you".
The objective part 1 is some text that varies. The objective part 1 is " can put the frisbee inside the chest within the cellar. That's it!".
