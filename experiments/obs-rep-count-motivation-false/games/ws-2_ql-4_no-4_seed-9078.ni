...
Test quest0_0 with "open suitcase / take sandwich from suitcase / go east / drop sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to make sure that the suitcase is open. And then, r".
The objective part 1 is some text that varies. The objective part 1 is "ecover the sandwich from the suitcase. Then, attempt to go east. Following that, throw the sandwich on the floor of the kitchenette. Got that? Good!".
